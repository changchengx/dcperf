...
$SNAP_RPC_SRC -s $SPDK_SOCK_SRC nvme_controller_create --pf_id 0 --ctrl NVMeCtrl1 --nqn nqn.2022-10.io.nvda.nvme:0 --mdts 6 --num_queues 2 --suspended
...
$SNAP_RPC_DST -s $SPDK_SOCK_DST nvme_controller_create --pf_id 0 --ctrl NVMeCtrl1 --nqn nqn.2022-10.io.nvda.nvme:0 --mdts 6 --num_queues 2 --suspended --live_update_listener
